...
function allAnagrams(str) {
    ...
    var generate = function (n, arr) {
        ...
        for (var i = 0; i < n; i++) {
            generate(n - 1, arr);
            if (n % 2 === 0) {
                _a = [arr[n - 1], arr[i]], arr[i] = _a[0], arr[n - 1] = _a[1]; // swap
            }
            else {
                _b = [arr[n - 1], arr[0]], arr[0] = _b[0], arr[n - 1] = _b[1]; // swap
            }
        }
    };
    generate(n, arr);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, ask(r1, 'Please enter the string : ')];
                case 1:
                    str = _a.sent();
                    r1.close();
                    ;
